      ...
      <div style={styles.content}>
        <div style={styles.statsRow}>
          <div style={styles.statCard}>
            ...
            <div style={{...styles.statValue, color: '#C94040'}}>{formatIDR(stats.total_pendapatan)}</div>
          </div>
          <div style={styles.statCard}>
        ...
        <div style={styles.sectionTitle}>Menu Terlaris</div>
        <div style={styles.menuPopular}>
          {menuTerlaris.length === 0
            ? <div style={{color: '#888780', fontSize: '12px', textAlign: 'center', padding: '8px'}}>Belum ada data penjualan untuk periode ini.</div>
            : menuTerlaris.map((menu, i) => (
              <div key={i} style={styles.menuItem}>
                ...
                <div style={styles.menuBarBg}>
                  <div style={{...styles.menuBarFill, width: `${(menu.total_terjual / maxTerjual) * 100}%`}} />
                </div>
        ...
        <div style={styles.sectionTitle}>Grafik Penjualan</div>
        ...
        <div className="print-report-preview" style={styles.previewOverlay}>
          <div style={styles.previewSheet}>
            ...
            <div style={styles.previewActions}>
              <button style={styles.previewBtnSecondary} onClick={() => setShowPreview(false)}>Tutup</button>
              <button style={styles.previewBtnPrimary} onClick={handlePrint}><IconPrinter size={16} /> Cetak</button>
            </div>
          </div>
        </div>
      )}
...
const styles = {
  ...
  headerTitle: { fontSize: '18px', fontWeight: '800', color: '#fff', textAlign: 'center', marginBottom: '14px' },
  periodeTabs: { display: 'flex', background: 'rgba(255,255,255,0.2)', borderRadius: '10px', padding: '3px', gap: '3px' },
  tabActive: { flex: 1, background: '#fff', color: '#C94040', border: 'none', borderRadius: '8px', padding: '9px 0', fontWeight: '800', fontSize: '12px', cursor: 'pointer', fontFamily: 'inherit' },
  tabInactive: { flex: 1, background: 'transparent', color: 'rgba(255,255,255,0.85)', border: 'none', borderRadius: '8px', padding: '9px 0', fontWeight: '700', fontSize: '12px', cursor: 'pointer', fontFamily: 'inherit' },
  content: { padding: '20px 16px 80px', flex: 1, overflowY: 'auto', marginTop: '-20px' },
  statsRow: { display: 'flex', gap: '10px', marginBottom: '20px' },
  statCard: { flex: 1, background: '#fff', borderRadius: '16px', padding: '16px', border: '1.5px solid #EAE5DA', textAlign: 'center' },
  ...
  menuPopular: { background: '#fff', borderRadius: '16px', padding: '14px 16px', marginBottom: '20px', border: '1.5px solid #EAE5DA' },
  menuItem: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' },
  menuBarBg: { flex: 1, height: '8px', background: '#F1EFE8', borderRadius: '8px', margin: '0 10px', overflow: 'hidden' },
  ...
  menuQty: { fontSize: '11px', color: '#888780', fontWeight: '600', minWidth: '40px', textAlign: 'right' },
  chartCard: { background: '#fff', borderRadius: '16px', padding: '16px', marginBottom: '20px', border: '1.5px solid #EAE5DA' },
  chartPlaceholder: { height: '120px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', padding: '0 10px', marginBottom: '10px' },
  bar: { width: '24px', background: '#C94040', borderRadius: '4px 4px 0 0', opacity: 0.8 },
  chartLabels: { display: 'flex', justifyContent: 'space-between', padding: '0 10px', fontSize: '10px', color: '#888780', fontWeight: '700' },
  exportBtn: { width: '100%', background: '#fff', border: '1.5px solid #C94040', color: '#C94040', padding: '14px', borderRadius: '14px', fontSize: '14px', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'inherit' },
  previewOverlay: { position: 'fixed', inset: 0, background: 'rgba(12, 18, 20, 0.62)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '18px', zIndex: 1000 },
  previewSheet: { width: '100%', maxWidth: '430px', background: '#fff', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.25)' },
  previewHeader: { background: '#C94040', padding: '16px 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  ...
  previewClose: { background: 'rgba(255,255,255,0.2)', border: 'none', borderRadius: '999px', color: '#fff', width: '34px', height: '34px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' },
  previewBody: { padding: '18px' },
  previewBrand: { fontSize: '18px', fontWeight: '800', color: '#2C2C2A', textAlign: 'center', marginBottom: '4px' },
  ...
  previewStatsGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '14px' },
  previewStatBox: { background: '#FFF6F6', border: '1px solid #F2D1D1', borderRadius: '14px', padding: '12px' },
  ...
  previewSectionTitle: { fontSize: '13px', fontWeight: '800', color: '#5F5E5A', marginBottom: '10px' },
  previewList: { display: 'flex', flexDirection: 'column', gap: '8px' },
  previewItemRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', background: '#FAFAFA', borderRadius: '12px' },
  ...
  previewBtnSecondary: { flex: 1, border: '1.5px solid #D3D1C7', background: '#fff', color: '#5F5E5A', borderRadius: '14px', padding: '12px', fontFamily: 'inherit', fontWeight: '800', cursor: 'pointer' },
  previewBtnPrimary: { flex: 1, border: 'none', background: '#C94040', color: '#fff', borderRadius: '14px', padding: '12px', fontFamily: 'inherit', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }
};
