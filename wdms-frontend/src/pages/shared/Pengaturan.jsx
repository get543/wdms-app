...
import { IconUser, IconUsers, IconBell, IconCloudDownload, IconInfoCircle, IconLogout, IconChevronRight } from '@tabler/icons-react';
...
const styles = {
  ...
  content: { padding: '20px 16px 80px', flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '-30px' },
  profileCard: { background: '#fff', borderRadius: '16px', padding: '16px', display: 'flex', alignItems: 'center', gap: '16px', border: '1.5px solid #EAE5DA', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' },
  avatar: { width: '56px', height: '56px', borderRadius: '50%', background: '#F1EFE8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' },
  ...
  menuGroup: { background: '#fff', borderRadius: '16px', border: '1.5px solid #EAE5DA', overflow: 'hidden' },
  menuItem: { padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1EFE8', cursor: 'pointer' },
  ...
  logoutBtn: { width: '100%', background: '#FFF0F0', border: '1.5px solid #F5C4B3', color: '#C94040', padding: '16px', borderRadius: '16px', fontSize: '15px', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'inherit' }
};
